...
class DatabaseService:
    ...
    def save_dr(self, dr_data: Dict) -> str:
        ...
        Args:
            dr_data: The full DR document dict - generated by the DRFactory.
        ...
        ## EXPLANATION:
        #  I'm going to use this function with this idea, every time I receive a new list of readings containing multiple events related to multiple devices,
        #  I'll separate the list by device_id and then for each device, I'll call this function to update/create the DR of the device based on the last reading.
