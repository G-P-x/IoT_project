...
def on_message(client, userdata, msg):
    ...
    try:
        ...
        if critical:
            ...
            # l'anomalia persiste, compensando l'auto-timeout del buzzer sull'ESP.
            ...
            print(f"[MQTT OUT] Buzzer ON inviato (anomalia attiva)")

        elif not critical and _alarm_active:
            # Buzzer OFF solo quando non ci sono piu' anomalie critiche.
            # I warning non mantengono il buzzer attivo.
            _alarm_active = False
